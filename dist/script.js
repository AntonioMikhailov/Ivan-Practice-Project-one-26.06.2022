...
Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState); // активируем-подключаем модуль и передаем пустой объект в который получим обратно данные из полей ввода
...
Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block'); // inline-block = display в параметрах ф.
...
Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('input[name="user_phone"]'); // передаем селектор
...
/* harmony default export */ __webpack_exports__["default"] = (tabs); // по умолчанию экспортируем
